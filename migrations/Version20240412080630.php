 ...
 */
final class Version20240412080630 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE artist (id INT AUTO_INCREMENT NOT NULL, user_id_user_id INT NOT NULL, label_id INT NOT NULL, fullname VARCHAR(90) NOT NULL, description LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_1599687DE94BC09 (user_id_user_id), UNIQUE INDEX UNIQ_159968733B92F39 (label_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
